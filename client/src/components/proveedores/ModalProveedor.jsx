...
// Modal de creacion de proveedor (campos basicos + SII). La activacion/edicion
// de IRPF NO se hace aqui — vive en el panel expandible de la fila de la tabla
// (PanelIrpfProveedor.jsx). Razon: para activar IRPF en un proveedor existente
// hace falta un disparador desde la tabla, no desde un modal de creacion.
            ...
            {!esEdicion && (
              <div className="col-span-2 border-t border-gray-100 pt-3 mt-1">
                <p className="text-xs text-gray-500">
                  ¿Este proveedor lleva retención IRPF? Crea el proveedor primero y luego expande su fila en la tabla para configurarlo.
                </p>
              </div>
            )}
          </div>
